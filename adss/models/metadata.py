...
class Table:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "Table":
        ...
        return cls(name=data.get("name"), columns=columns)
...
class Schema:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "Schema":
        ...
        tables = [Table.from_dict(table_data) for table_data in data.get("tables", [])]

        return cls(name=data.get("name"), tables=tables)
...
class DatabaseMetadata:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "DatabaseMetadata":
        ...
        schemas = [
            Schema.from_dict(schema_data) for schema_data in data.get("schemas", [])
        ]
