...
from adss.endpoints.images import (
    ImagesEndpoint,
...
class ADSSClient:
    ...
    def query_and_wait(
        ...
        **kwargs,
        ...
        Returns:
            QueryResult object containing the query data and metadata
        """
        return self.queries.execute_and_wait(
            query_text, mode, file, table_name, timeout, verbose, **kwargs
        )
    ...
    def pretty_print_db_metadata(
        self, dbmeta: Optional[DatabaseMetadata] = None
    ) -> None:
        """
    ...
    def update_profile(
        self, email: Optional[str] = None, full_name: Optional[str] = None, **kwargs
    ) -> User:
        """
    ...
    def add_schema_permission(
        self, role_id: int, schema_name: str, permission: str, **kwargs
    ) -> bool:
        """
        ...
        """
        return self.admin.add_schema_permission(
            role_id, schema_name, permission, **kwargs
        )

    def add_table_permission(
        self, role_id: int, schema_name: str, table_name: str, permission: str, **kwargs
    ) -> bool:
        """
        ...
        Returns:
            True if the permission was successfully added
        """
        return self.admin.add_table_permission(
            role_id, schema_name, table_name, permission, **kwargs
        )

    def remove_schema_permission(
        self, role_id: int, schema_name: str, **kwargs
    ) -> bool:
        """
    ...
    def remove_table_permission(
        self, role_id: int, schema_name: str, table_name: str, **kwargs
    ) -> bool:
        """
        ...
        Returns:
            True if the permission was successfully removed
        """
        return self.admin.remove_table_permission(
            role_id, schema_name, table_name, **kwargs
        )
    ...
    def list_files(
        ...
        **kwargs,
        ...
        return self.images.list_files(
            ...
            filter_str,
            object_name,
            obsdate_min=obsdate_min,
            obsdate_max=obsdate_max,
            **kwargs,
        )

    def cone_search_images(
        self,
        collection_id: int,
        ra: float,
        dec: float,
        ...
        **kwargs,
        ...
        """
        return self.images.cone_search(
            collection_id, ra, dec, radius, filter_name, limit, **kwargs
        )
    ...
    def create_rgb_image(
        ...
        **kwargs,
        ...
        """
        return self.lupton_images.create_rgb(
            r_file_id,
            g_file_id,
            b_file_id,
            ra,
    ...
    def create_rgb_image_by_coordinates(
        self,
        collection_id: int,
        ra: float,
        dec: float,
        ...
        **kwargs,
        ...
        Returns:
            ...
            Otherwise, returns the image data as bytes.
        """
        return self.lupton_images.create_rgb_by_coordinates(
            collection_id,
            ra,
            dec,
            size,
    ...
    def create_stamp(
        ...
        **kwargs,
        ...
        Returns:
            ...
            Otherwise, returns the image data as bytes.
        """
        return self.stamp_images.create_stamp(
            file_id, ra, dec, size, size_unit, format, zmin, zmax, output_path, **kwargs
        )
    ...
    def create_stamp_by_coordinates(
        ...
        **kwargs,
        ...
        Returns:
            ...
            Otherwise, returns the image data as bytes.
        """
        return self.stamp_images.create_stamp_by_coordinates(
            collection_id,
            ra,
            dec,
            size,
    ...
    def create_trilogy_rgb(
        ...
        **kwargs,
        ...
        Returns:
            ...
            Otherwise, returns the image data as bytes.
        """
        return self.trilogy_images.create_trilogy_rgb(
            r_file_ids,
            g_file_ids,
            b_file_ids,
            ra,
